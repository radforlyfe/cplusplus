...
namespace basic {
    ...
    public:
        ...
        /**
         ...
         @param rhs toAppend the string being appended
         */
    ...
    private:
        ...
        // the members down here aren't part of the working class, but they are helpful for illustration to see what happens as class objects are created and destroyed
